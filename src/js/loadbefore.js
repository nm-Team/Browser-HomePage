...
if (nowChannel != "main") {
    // document.write("<p class='insiderTip' id='insiderTip'>您正在通过 " + nowChannel + " 通道访问 nmBrowser 启动页。<a href='javascript:document.getElementById(`insiderTip`).style.visibilty=`hidden`;'></a></p>");
